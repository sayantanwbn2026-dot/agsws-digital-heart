...
const iconMap: Record<string, any> = { Clock, Heart, MapPin, CheckCircle };

const defaultData = {
  badge: "Impact Story",
  headline: "How ₹5,000 Changed Ranu's Story",
  description: "Ranu Mondal, 67, from North Kolkata, was alone when she needed emergency cardiac care. Her son in Bengaluru had registered her through AGSWS six months before. Within 2 hours of her collapse, our team had her admitted at a network hospital.",
  pills: ["₹5,000 donated", "2-hour response", "Full recovery"],
  milestones: [
    { label: "Registered", detail: "Son registered from Bengaluru" },
    { label: "Emergency", detail: "Cardiac event — team mobilised" },
    { label: "Admitted", detail: "Network hospital in 2 hours" },
    { label: "Recovered", detail: "Full recovery in 12 days" },
  ],
  case_ref: "AGS-2024-082",
  verified_date: "15 Jan 2025",
};

const milestoneIcons = [Clock, Heart, MapPin, CheckCircle];
                ...
                <div className="bg-white rounded-[var(--radius-2xl)] p-8 shadow-[0_24px_64px_rgba(0,0,0,0.3)]">
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      ...
                      <p className="text-[20px] font-[700] text-[var(--dark)] mt-1">{data.case_ref}</p>
                    </div>
                  ...
                  <div className="relative pl-6 space-y-0 mb-6">
                    ...
                    {data.milestones.map((m, i) => {
                      const Icon = milestoneIcons[i] || CheckCircle;
                      return (
                        <motion.div
                          key={m.label}
                  ...
                  <div className="mt-5 flex items-center gap-2">
                    ...
                    <span className="text-[11px] font-[600] text-[var(--teal)] uppercase tracking-[0.06em]">AGSWS Verified · {data.verified_date}</span>
                  </div>
                </div>
              </FadeInUp>
            </motion.div>
