...
const heroFields: FieldConfig[] = [
  ...
  { key: 'live_activity_enabled', label: 'Show Live Activity Ticker', type: 'boolean' as any },
...
const sections = [
  ...
  { id: 'volunteers_directory', label: 'Volunteers Directory', icon: Users, table: 'cms_volunteers', fields: ([
    { key: 'volunteer_id', label: 'Volunteer ID (e.g. VOL-2025-0042)', type: 'text', required: true, placeholder: 'VOL-2025-0042' },
    { key: 'name', label: 'Full Name', type: 'text', required: true },
    { key: 'role', label: 'Role / Title', type: 'text', placeholder: 'Field Volunteer' },
    { key: 'since', label: 'Volunteer Since (year)', type: 'text', placeholder: '2024' },
    { key: 'email', label: 'Email', type: 'text' },
    { key: 'phone', label: 'Phone', type: 'text' },
    { key: 'total_hours', label: 'Total Hours (auto-fallback: sum of categories)', type: 'number' },
    { key: 'hours_field', label: 'Hours — Field', type: 'number' },
    { key: 'hours_medical', label: 'Hours — Medical', type: 'number' },
    { key: 'hours_education', label: 'Hours — Education', type: 'number' },
    { key: 'hours_admin', label: 'Hours — Admin', type: 'number' },
    { key: 'activities_json', label: 'Recent Activities (JSON array of {date, desc, hours})', type: 'textarea', placeholder: '[{"date":"Mar 2025","desc":"Medical camp at Howrah","hours":6}]' },
    { key: 'certificate_password', label: 'Certificate Password (shared privately with the volunteer)', type: 'text', placeholder: 'e.g. agsws-2025' },
    { key: 'is_published', label: 'Active (visible in Volunteer Portal)', type: 'boolean' },
  ] as FieldConfig[]), group: 'Operations' },
  ...
  { id: 'register_parent', label: 'GoldenAge Care Page', icon: Heart, table: '', fields: [], isCustom: true, group: 'Pages' },
...
const AdminDashboard = () => {
  ...
  const renderCustomSection = () => {
    ...
    if (activeSection === 'about_counters') return <SectionEditor sectionKey="about_counters" title="About — Counter Band" description="Big numbers band on the About page" fields={[]} listKey="items" listFields={[{ key: 'value', label: 'Value (e.g. 2,400+)', type: 'text' }, { key: 'label', label: 'Label', type: 'text' }]} />;
