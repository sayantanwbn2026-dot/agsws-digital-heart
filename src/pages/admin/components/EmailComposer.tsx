      ...
      <div className="grid grid-cols-1 lg:grid-cols-2  gap-5 lg:gap-8">
        <div className="global-card space-y-5">
          <div>
            ...
            <select value={group} onChange={(e) => setGroup(e.target.value)} className="global-card w-full h-12 outline-none focus: text-sm">
          ...
          <div>
            ...
            <input placeholder=" " value={subject} onChange={(e) => setSubject(e.target.value)} className="global-card w-full h-12 outline-none focus:" placeholder="Email subject line" />
          </div>

          <div>
            <label className="text-xs font-semibold uppercase text-text-light tracking-wide mb-2 block">From Name</label>
            <input placeholder=" " defaultValue="AGSWS Team" className="global-card w-full h-12 outline-none focus: text-sm" />
          </div>

          <div>
            <label className="text-xs font-semibold uppercase text-text-light tracking-wide mb-2 block">Message</label>
            <textarea placeholder=" " value={message} onChange={(e) => setMessage(e.target.value)} rows={8} className="global-card w-full outline-none focus: text-sm resize-y" placeholder="Write your message..." />
          </div>
